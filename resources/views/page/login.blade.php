              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Chương trình quản lý điểm BBBBBBBBBB</h1>
                  </div>
                   @if(count($errors)>0)
                    ...
                    @endif
                  <form action ="loginn" method="post" class="user">
                    {!! csrf_field() !!}
                    <div class="form-group">
                      <label>Tên đăng nhập: </label>
                      <input type="text" class="form-control form-control-user" id="exampleInputAccount"  placeholder="Tên đăng nhập" name="account">
                    </div>
                    <div class="form-group">
