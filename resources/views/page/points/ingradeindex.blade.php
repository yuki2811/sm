...
@section('title')
<title>Thống kê theo khối</title>
@endsection
@section('content')
<div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">Thống kê học lực theo khối</h3>
              <button  class="btn btn-primary btn-xs delete_sem"  data-url=""><i class="fa fa-print" aria-hidden="true"></i> <a style="color: white;" href="{{ route('admin.gradeexport', ['sems' => $sem['id'],'grades' => $grade['id'],'subsems' => $subsem]) }}">Xuất excel</a></button>
